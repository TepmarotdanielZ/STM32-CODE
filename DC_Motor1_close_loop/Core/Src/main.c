...
uint16_t count[1]; // count pulse from encoder
uint16_t new_count[1];
uint8_t count_state[1];
uint16_t diff[1]; // difference between count and new_count in a sample time
